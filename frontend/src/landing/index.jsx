      ...
      <main>
        ...
        <section className="hero">
          ...
          <div className="hero-content">
            ...
            <p className="hero-description">
              Track every application, interview, deadline and follow-up
              in one calm, organized workspace. Spend less time managing
              your job search and more time landing the right opportunity.
            </p>
        ...
        <section className="features-section" id="features">
          ...
          <div className="section-heading">
            ...
            <p>
              TrackHire replaces scattered spreadsheets, browser tabs,
              notes and reminders with one focused workspace.
            </p>
        ...
        <section className="workflow-section" id="how-it-works">
          ...
          <div className="workflow-intro">
            ...
            <p>
              A simple workflow designed around the way a real job
        ...
        <section className="highlight-section">
          ...
          <div className="highlight-content">
            ...
            <p>
              Job hunting can quickly become overwhelming. Twenty tabs,
              five spreadsheets and dozens of applications later,
        ...
        <section className="reviews-section" id="reviews">
          ...
          <div className="section-heading centered">
            ...
            <p>
              A few words from the people TrackHire is designed for.
            </p>
        ...
        <section className="cta-section">
          ...
          <div className="cta-inner">
            ...
            <p>
              Stop losing track of opportunities. Start building
              a job search you can actually manage.
            </p>

            <Link to="/auth" className="cta-button">
              Start using TrackHire
              <ArrowRight size={18} />
            </Link>
      ...
      <footer className="landing-footer" id="about">
        ...
        <div className="footer-main">
          ...
          <div className="footer-brand">
            ...
            <p>
              A calmer, smarter way to manage your job search.
            </p>
